...
def on_end_epoch(state):
    ...
    torch.save(model.state_dict(), 'epochs/epoch_%d_%d.pth' % (UPSCALE_FACTOR, state['epoch']))
...
if __name__ == '__main__':
    ...
    # 模型
    model = ESPCNModel(upscale_factor=UPSCALE_FACTOR)
    # 损失函数
